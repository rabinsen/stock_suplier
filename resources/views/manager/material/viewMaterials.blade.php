                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            @foreach($materials as $material)
                                <tr>
                                    ...
                                    <td>
                                        @if( $material->flag == 0)
                                            <form class="form-validate form-horizontal" method="POST" action="{{ url('/checkReceipt', $material->id) }}">
                                                {{ csrf_field() }}
                                                <button class="btn btn-danger">Not Received</button>
                                            </form>
                                        @elseif( $material->flag == 1)
                                            <a class="btn btn-primary" href="#">Received</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
